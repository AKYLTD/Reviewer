...
function ChipButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      aria-pressed={active}
      className={`inline-flex items-center justify-center min-h-11 rounded-pill px-4 py-2 font-display font-600 text-sm transition focus-visible:outline-2 focus-visible:outline-brick focus-visible:outline-offset-2 ${
        active
